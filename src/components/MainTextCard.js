...
const MainTextCard = () => {
    ...
    >
                <Paper elevation={5} sx={{backgroundColor: 'primary.main'}}>
                    <Button padding={5}  variant='outlined'sx={{ color: 'primary.button', display: 'block', justifyContent: 'center', alignItems: 'center', width: '100%', backgroundColor: 'primary.button'}}>
